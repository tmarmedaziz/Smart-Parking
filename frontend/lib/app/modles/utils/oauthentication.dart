...
class OAuthSettings {
  final OAuth _oauth = OAuth(
    tokenUrl: 'https://api.modernparker.me/oauth/token',
    refreshUrl: 'https://api.modernparker.me/oauth/refresh',
    loginUrl: 'https://api.modernparker.me/oauth/signin',
    preLoginUrl: 'https://api.modernparker.me/oauth/presignin',
